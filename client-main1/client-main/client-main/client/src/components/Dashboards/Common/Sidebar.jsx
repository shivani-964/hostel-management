    ...
    <div>
      ...
      >
        ...
        >
          ...
          <span className="md:hidden lg:inline">HMS</span>
        </Link>
        <div className="flex flex-col px-5 text-xl space-y-1 text-white">
          {/*eslint-disable-next-line react/prop-types*/}
          {links.map((link) => (
            <Link
              to={link.url}
              key={link.url}
              className="py-3 px-4 flex my-2 items-center gap-2 rounded-md hover:bg-[#202020]"
            >
              {link.svg}
              {link.text}
            </Link>
